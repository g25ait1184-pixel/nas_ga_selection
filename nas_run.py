...
best_arch = ga.evolve(train_loader, val_loader, device, run=len(all_logs)+1,selection_method="tournament")
...
best_arch = ga1.evolve(train_loader, val_loader, device, run=len(all_logs)+1,selection_method="roulette")
